...
class ApprovalInstanceAbleMixin(models.AbstractModel):
    ...
    approval_task_line = fields.One2many('approval.task.line', related='approval_instance_id.approval_task_line', string='Approval Task Lines')
    ...
    def compute_access_request_approval_action(self):
        for rec in self:
            # todo
            is_request_approval = rec.is_status_request_approval()
            rec.access_request_approval_action = is_request_approval
    ...
    def is_status_request_approval(self):
        ...
        return approval_instance and approval_instance.is_status_request_approval()
