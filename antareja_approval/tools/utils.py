...
def get_internal_url(rec_object):
    """
    Get the internal URL from the record object.
    This method should be implemented in the inheriting model.
    """
    if "internal_url" in rec_object:
        return rec_object['internal_url']
    elif have_method(rec_object, "get_internal_url"):
        return rec_object.get_internal_url()
    return None
