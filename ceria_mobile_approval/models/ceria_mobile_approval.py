...
class CeriaMobileApproval(models.Model):
    ...
    source_number = fields.Char("Document Number")
    source_document = fields.Char("Document Type")
    source_originator_name = fields.Char("Originator Name")
    source_approval_model = fields.Char()
    source_approval_res_id = fields.Integer()
    ...
    def unregister_user_approval(self,data):
        if self:
            ...
            domain = [('source_application', '=', source_application),('source_model', '=', source_model),('source_res_id', '=', source_res_id)]
